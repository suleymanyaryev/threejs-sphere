...
export class N {
    ...
    onMouseMove(e) {
        let t = this.mouse.x;
        let o = this.mouse.y;
        this.mouse.x = someFunction(
            t,
            e.clientX / this.viewport.width - 0.5,
            1
        );
        this.mouse.y = someFunction(
            o,
            e.clientY / this.viewport.height - 0.5,
            1
        );
    }
    ...
    update() {
        this.render();
        this.mesh.rotation.y = someFunction(
            this.mesh.rotation.y,
            this.mouse.x,
            0.075
        );
        this.mesh.rotation.x = someFunction(
